...
import { Home, Search, Briefcase, Settings, Activity, Users, ShieldAlert, Radio, Zap, TestTube } from 'lucide-react';
...
export function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  const navItems = [
    ...
    { id: 'retailtrap', label: 'Retail Trap Radar', icon: Radio },
    { id: 'quant', label: 'Quant Terminal', icon: TestTube },
